...
namespace Conecting
{
    ...
    // =========================================================================
    // PEER RESOLUTION ENGINE WITH PERSISTENT NODE ID AND CUSTOM PSK KEY
    // =========================================================================
    public static class PeerResolver
    {
        ...
        public static TcpClient DiscoverAndConnectPeer(string targetId, string myId, string pskKey, out string remoteHostname, out string errorMsg)
        {
            ...
            try
            {
                ...
                TcpClient client = TrySocketConnect(targetHost, RelayServerPort, myId, cleanTargetId, pskKey, out remoteHostname, 2000);
            ...
            try
            {
                TcpClient fallbackClient = TrySocketConnect(RelayServerDomain, RelayServerPort, myId, cleanTargetId, pskKey, out remoteHostname, 2000);
                if (fallbackClient != null) return fallbackClient;
            }
            catch { }

            errorMsg = "Unable to connect to Relay Server. Please check your network connection.";
            return null;
        }
    ...
    public class MainForm : Form
    {
        ...
        private void BuildSettingsTab()
        {
            ...
            CheckBox c2 = new CheckBox { Text = "Aislamiento total de teclado sin interferencias locales (ProcessDialogKey + Hook)", Checked = true, Location = new Point(24, 190), AutoSize = true, Font = new Font("Segoe UI", 10F) };
            CheckBox c3 = new CheckBox { Text = "Acceder a portapapeles bidireccional en tiempo real", Checked = true, Location = new Point(24, 225), AutoSize = true, Font = new Font("Segoe UI", 10F) };
            CheckBox c4 = new CheckBox { Text = "Minimizar a la barra de tareas (Segundo Plano al presionar Cerrar X)", Checked = true, Location = new Point(24, 260), AutoSize = true, Font = new Font("Segoe UI", 10F) };
            CheckBox cAudio = new CheckBox { Text = "Transmitir Audio del Equipo Remoto (Desactivado por defecto)", Checked = false, Location = new Point(24, 295), AutoSize = true, Font = new Font("Segoe UI", 10F, FontStyle.Bold), ForeColor = Color.FromArgb(71, 85, 105) };
